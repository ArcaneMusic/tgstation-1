...
/datum/feed_network
	...
	/// The feed_channel to be used by station annoucements.
	var/datum/feed_channel/station_annoucements


/datum/feed_network/New()
	station_annoucements = new /datum/feed_channel
	station_annoucements.channel_name = "Station Annoucements"
	station_annoucements.description = "All your station news, right here. Sponsored by Nanotrasen."
	station_annoucements.icon = "newspaper"
	station_annoucements.author = "Nano-News Network"
	station_annoucements.is_public = TRUE
	station_annoucements.admin_locked = TRUE
	GLOB.news_network.channels += station_annoucements
...
/datum/feed_message/proc/build_message(_author, _title, _message, icon/_img, _censor_flags, _admin_locked)
	author = _author
	title = _title
	body = _message
	img = _img
	censor_flags = _censor_flags
	admin_locked = _admin_locked
	return
